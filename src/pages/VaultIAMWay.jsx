    ...
    <div className="min-h-screen bg-white">
      ...
      >
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-12">
            ...
            <h2 className="text-slate-900 mb-4" style={{ fontSize: "clamp(28px, 4vw, 38px)", fontWeight: 700, letterSpacing: "-0.02em" }}>
              Why <span style={{ color: "#2563eb" }}>VaultIAM</span> is Different
            </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                {[
                  "100% dedicated to identity security (not a service line)",
                  "FinTech & Healthcare sector expertise (not all industries)",
                  "Hands-on architects who've solved these problems before",
                  "Technology-agnostic (Okta, Entra, CyberArk, HashiCorp, etc.)",
                  "Outcomes-first, not billable hours",
                  "You own the solution, not us"
                ].map((item, i) => (
                  <div key={i} className="flex gap-3 items-start">
                    ...
                    <span className="text-slate-700" style={{ fontSize: 15, lineHeight: 1.6, fontWeight: 500 }}>{item}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      >
        <div className="max-w-4xl mx-auto px-5 text-center">
          <h2 className="text-white mb-6" style={{ fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 700, letterSpacing: "-0.02em" }}>
            Identity is the New Perimeter
          </h2>
          <p className="text-slate-300 mb-8" style={{ fontSize: 17, lineHeight: 1.7, maxWidth: 700, margin: "0 auto 32px" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg transition-colors"
            ...
            <Link
              to="/customer-stories"
              className="inline-flex items-center justify-center gap-2 bg-slate-700 hover:bg-slate-600 text-white px-8 py-4 rounded-lg transition-colors"
              style={{ fontSize: 15, fontWeight: 600 }}
            >
              See Client Results
            </Link>
          ...
          <p className="text-slate-400" style={{ fontSize: 13 }}>
            No sales pressure. No generic pitch decks. Just pure identity expertise and clear next steps.
          </p>
        </div>
      </section>
    </div>
