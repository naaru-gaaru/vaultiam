            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>Fraud detection rate: <strong>67%</strong></span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-red-500 mt-0.5">✗</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>False positive rate: <strong>18%</strong></span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-red-500 mt-0.5">✗</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>Avg onboarding time: <strong>4.2 min</strong></span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>Fraud detection rate: <strong>94%</strong></span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-green-600 mt-0.5">✓</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>False positive rate: <strong>3%</strong></span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-green-600 mt-0.5">✓</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>Avg onboarding time: <strong>2.8 min</strong></span>
                </div>
              </div>
            </div>
          </div>
