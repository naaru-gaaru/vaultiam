            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>Manual identity reviews: <strong>48 hours</strong></span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-red-500 mt-0.5">✗</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>Zero AI agent visibility</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-red-500 mt-0.5">✗</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}><strong>12+ HIPAA</strong> audit findings</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}>Real-time detection: <strong>&lt;5 min</strong></span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-green-600 mt-0.5">✓</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}><strong>100%</strong> AI agent visibility</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-green-600 mt-0.5">✓</span>
                  <span className="text-slate-700" style={{ fontSize: 13, lineHeight: 1.5 }}><strong>Zero</strong> HIPAA findings (12-month audit)</span>
                </div>
              </div>
            </div>
          </div>
